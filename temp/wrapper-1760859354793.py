...
# Read input
with open(r"C:\\Users\\Hlib\\Desktop\\algoflow\\AlgoFlow\\temp\\input-1760859354786.json", "r") as f:
    data = json.load(f)
...
# Write output
with open(r"C:\\Users\\Hlib\\Desktop\\algoflow\\AlgoFlow\\temp\\output-1760859354786.json", "w") as f:
